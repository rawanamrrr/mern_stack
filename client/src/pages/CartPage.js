        ...
        <div className="container ">
          <div className="row ">
            ...
            <div className="col-md-5 cart-summary ">
              ...
              {auth?.user?.address ? (
                <>
                  <div className="mb-3">
                    ...
                    <h5>Governorate: {auth?.user?.governorate}</h5>
                    <h5>Apartement: {auth?.user?.apartement}</h5>
                    <h5>Phone number: {auth?.user?.phone}</h5>
                    <h5>Postal code: {auth?.user?.postalCode}</h5>
                    <button
              ...
              <h4>Shipping Fees : {totalFees()} </h4>
              <h4>Total with Shipping Fees : {totalPrice()} </h4>
              ...
              <div className="mt-2">
                {!clientToken || !auth?.token || !cart?.length ? (
                  ...
                  <div className="mt-2">
              <div className="row">
                <h6 className="font-weight-bold mb-4">Payment Method</h6>
                <form>
                  <div>
